				...
				<table id="productTable">
					...
					<tbody>
						...
						<tr class="tr_class1">
							...
							<td>
								<button class="button_add" onclick="openModal()">Thêm
									mới</button>
								<button class="button_delete button_delete1"
									id_cameras="<%=cameraProject.get(i).getCamera_ID()%>">Xóa</button>
							</td>
						</tr>
						<%
						}
				...
				<div id="modal" class="modal">
					<div class="modal-content">
						...
						<form id="New_Product_Form">
							<input type="hidden" id="editIndex"> <label
								for="Camera_name">Camera Name:</label> <input type="text"
								id="Camera_name" name="cameraame" required><br> <label
								for="IP_address">IP_address:</label> <input type="text"
								id="IP_address" name="ipadress" required><br> <label
								for="Status">Status:</label> <input type="text" id="Status"
								name="status" required><br> <label for="Project">Project:</label>
							<input type="text" id="Project" name="projectname" required><br>
							<button type="submit" id="btn_add_cam"
								onclick="saveCamera(event)">Save</button>
						</form>
			...
			<div class="manage-conten">
				<table id="userTable">
					...
					<tbody class="tbody_class">
						...
						<tr class="tr_class">
							...
							<td>
								<button class="button_add" onclick="openModal2()">Thêm
									mới</button>
								<button class="button_fix" onclick="edit2(this)"
									id_user1="<%=user.get(i).getUsers_ID()%>">Sửa</button>
								<button class="button_delete button_delete2"
									onclick="deleteRow2(this)"
									id_user="<%=user.get(i).getUsers_ID()%>">Xóa</button>
							</td>
						</tr>
						<%
						}
				...
				<div id="modal2" class="modal">
					<div class="modal-content">
						...
						<form id="New_User_Form">
							<input type="hidden" id="editIndex2"> <label
								for="Users_name">Users_name:</label> <input type="text"
								id="Users_name" name="username" required><br> <label
								for="Full_name">Full_name:</label> <input type="text"
								id="Full_name" name="fullname" required><br> <label
								for="Email">Email:</label> <input type="text" id="Email"
								name="email" required><br> <label for="Phone">Phone:</label>
							<input type="text" id="Phone" name="phone" required><br>
							<label for="Phone">Password:</label> <input type="text"
								id="Password" name="password" required><br> <label
								for="Role">Role:</label> <input type="text" id="Role"
								name="roleid" required><br>
				...
				<div id="modal3" class="modal">
					<div class="modal-content">
						...
						<form id="New_User_Form">
							<input type="hidden" id="editIndex3"> <input
								type="hidden" id="User_ID3" name="userid"> <label
								for="Users_name">Users_name:</label> <input type="text"
								id="Users_name3" name="username" required><br> <label
								for="Full_name">Full_name:</label> <input type="text"
								id="Full_name3" name="fullname" required><br> <label
								for="Email">Email:</label> <input type="text" id="Email3"
								name="email" required><br> <label for="Phone">Phone:</label>
							<input type="text" id="Phone3" name="phone" required><br>
							<label for="Password">Password:</label> <input type="text"
								id="Password3" name="password" required><br> <label
								for="Role">Role:</label> <input type="text" id="Role3"
								name="roleid" required><br>
