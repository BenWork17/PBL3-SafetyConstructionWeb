...
<%
for (CameraProject cameraProject : cameraProjects) {
%>
{ Project_name: '<%=cameraProject.getProject_name()%>', Camera_name: '<%=cameraProject.getCamera_name()%>',
IP_address: '<%=cameraProject.getIP_address()%>' },
	...
	<div class="wrapper">
		<div class="item-list">
			...
			<div id="item-cctv-view-all" class="item-cctv-view-all"
				...
				<div class="incon">
					<svg class="svg-mutil_cctv" xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 576 512">
                        <path
			...
			<div id="item-site-A" class="item-site-A"
				onclick="toggleClicked(this);showPage('site-A')">
				<div class="incon">
					<svg class="svg-mutil_cctv" xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 576 512">
                        <path
			...
			<div class="item-site-B"
				onclick="toggleClicked(this);showPage('site-B')">
				<div class="incon">
					<svg class="svg-mutil_cctv" xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 576 512">
                        <path
			...
			<hr>
			<div class="item-show-bookmark"
				onclick="toggleClicked(this);showPage('show-bookmark')">
				<div class="incon"></div>
